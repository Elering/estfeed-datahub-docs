...
| POST   | /api/v1/meter-data/status                    | v1       | retired | 22.11.2024       | 30.06.2026 | 31.01.2027 | Transition to v2 required. From 17 November 2026, gas metering data message statuses can only be retrieved via the V2 API.                                                                      |
