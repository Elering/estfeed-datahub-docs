...
| PUT    | /api/v2/agreements/{id}                      | v2      | active     | 17.09.2025      | -               | -               |                                                                             |
| POST   | /api/v1/template/meter                       | v1      | deprecated | 22.11.2024      | 10.11.2025      | 30.05.2026      | Transition to v2 required.                                                  |
| POST   | /api/v2/template/meter                       | v2      | active     | 10.11.2025      | -               | -               |                                                                             |
...
| POST   | /api/v1/meter/import                         | v1      | deprecated | 22.11.2024      | 10.11.2025      | 30.05.2026      | Transition to v2 required.                                                  |
| POST   | /api/v2/meter/import                         | v2      | active     | 10.11.2025      | -               | -               |                                                                             |
| POST   | /api/v1/meter/export                         | v1      | deprecated | 22.11.2024      | 10.11.2025      | 30.05.2026      | Transition to v2 required.                                                  |
| POST   | /api/v2/meter/export                         | v2      | active     | 10.11.2025      | -               | -               |                                                                             |
| POST   | /api/v1/meter/eic/amount                     | v1      | active     | 22.11.2024      | -               | -               |                                                                             |
| POST   | /api/v1/meter/eic/range                      | v1      | active     | 22.11.2024      | -               | -               |                                                                             |
| POST   | /api/v1/meter-data                           | v1       | active | 22.11.2024       | 01.08.2026                | -                 | Starting from 01.08 can't be used by Grid Operators and Closed Distribution Networks. 
| POST   | /api/v2/metering-data/electricity                           | v2      | upcoming | 01.08.2026       | -               | -                 |                                                                   |
| POST   | /api/v1/meter-data/status                    | v1       | active | 22.11.2024       | -                | -                 |                                                                       |
| POST   | /api/v1/meter-data/search                    | v1       | active | 22.11.2024       | 01.08.2026                | -                 | Does not return net measured quantities.
| GET   | /api/v2/metering-data/electricity                    | v2       | upcoming | 01.08.2026       | -                | -                 |                                                                         |
| POST   | /api/v1/meter-data/import                    | v1       | active | 22.11.2024       | 01.08.2026                | 01.08.2026                 |Web interface will use v2 starting from 01.08.2026.                                                                    |
| POST   | /api/v1/meter-data/export                    | v1       | active | 22.11.2024       | 01.08.2026                | 01.08.2026                | Web interface will use v2 starting from 01.08.2026.                                                                     |
| POST   | /api/v1/template/meter-data                  | v1       | active | 22.11.2024       | 01.08.2026                | 01.08.2026                | Web interface will use v2 starting from 01.08.2026.                                                                      |
...
| POST   | /api/v1/data-distribution/search             | v1      | active     | 22.11.2024      | -               | -               | Starting from 31.02.2026 this can't be used for agreement related messages and starting from 01.08.2026 can't be used for metering data and network bill |
| GET    | /api/v2/data-distributions/agreement         | v2      | active     | 17.09.2025      | -               | -               |                                                                             |
| GET    | /api/v2/data-distributions/metering-data/electricity        | v2       | upcoming | 01.08.2026      | -                | -                 |                                                                       |
