...
The rules of open supply and supplier change are provided for in the Electricity Market Act and the requirements set out in the Network Code on the Operation of the Electricity Market. 
In the gas market, the rules for open supply and supplier change are defined by the requirements laid down in the Natural Gas Act and the Gas Market Network Code.
This document outlines the process and rules on how the open supplier change takes place as of **01.01.2023**.
...
In the Datahub, the rules for the open supplier change procedure are based on the Electricity Market Act and the Network Code for the electricity market, and on the Natural Gas Act and the Gas Market Network Code for the gas market.

1. The open supplier enters the start time of an open supply agreement at the metering point to the Datahub.
2. An open supply agreement can be terminated by the open supplier itself for its own open supply agreements or by the Datahub when a new open supplier registers a new open supply agreement for a customer at the metering point.
3. If an open supplier cancels or otherwise terminates an open supply agreement, they must enter the termination details in the Datahub.
4. The new open supplier submits a notice concerning the new open supply agreement to the Datahub by the deadline specified in the legislation.
...
1. In the gas market, the open supplier can generally be changed (the agreement enters into force) at the change of a calendar month.
Exceptions: an open supply agreement ends in the middle of the month if this coincides with the end date of the grid agreement.
An open supply agreement starts in the middle of the month if this coincides with the start date of the grid agreement.
...
In the electricity market, an open supplier change may take place on any calendar day, in the gas market, it generally takes place at the turn of the month, following the process described below:
...
To change the supplier, the market participant can terminate the existing open supply agreement via entering into an agreement with a new open supplier, authorising the new open supplier to terminate its existing open supply agreement through the Datahub. The timing for changing a open supplier is determined, in the electricity market, by the Operation of the Electricity Market, and in the gas market, by the Operation of the Gas Market.
...
|-----------------------------------------------------------------|------------------------|-----|
| Start time of a new grid agreement                              | On 22.04.2017 at 00:00 | On 22.04.2017 at 07.00 |
| Grid operator deadline for entering a new grid agreement        | On 21.04.2017 at 23:59 | On 22.04.2017 at 06.59 |
| Open supplier deadline for entering a new open supply agreement | On 23.04.2017 at 23.59 | On 24.04.2017 at 06.59 |
