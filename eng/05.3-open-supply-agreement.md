...
- The Datahub makes the added or changed open supply agreement information available to the grid operator and aggregator using the `change` service.
- In the case of an open supplier change, the Datahub makes the information available to the previous open supplier via the `change` service.
