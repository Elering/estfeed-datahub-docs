...
* [Agreement amendments requiring coordination](#agreement-amendments-requiring-coordination)
  ...
  * [Agreement coordination via web interface](#agreement-coordination-via-web-interface)
    ...
    * [Modify or delete an existing agreement that needs to be coordinated](#modify-or-delete-an-existing-agreement-that-needs-to-be-coordinated)
...
1. An open supplier enters a request to:
   2. change the start or end date of an open supply agreement OR
   3. create new open supply agreement OR
   4. delete existing open supply agreement
...
### Modify or delete an existing agreement that needs to be coordinated

1. In the open supplier role, open the “Agreements” page.
2. Find the agreement you want to modify or delete. 
3. Click the button "Coordination".
![Coordination button](../images/opp-ui/agreement-coordination/agreement-coordination-coordination-button-eng.png)
4. System will open a modal window. First choose the desired action: Modify or delete the agreement
![Modify or delete modal](../images/opp-ui/agreement-coordination/agreement-coordination-modify-delete-modal-eng.png)
5. Depending on the made choice:
* Modify - update the agreement dates as needed and add a justification for the modification.
![Modify modal](../images/opp-ui/agreement-coordination/agreement-coordination-modify-delete-modal-modify-eng.png)
* Delete - add a justification for the modification.
![Delete modal](../images/opp-ui/agreement-coordination/agreement-coordination-modify-delete-modal-delete-eng.png)
6. Click “Initiate coordination” to submit the agreement for coordination.
7. The coordination is now initiated and can be found on the “Agreement Coordination” page.

### Search and approve Agreement Coordinations

1. Open the “Agreement Coordination” page.
2. Click "Search"
![Search button](../images/opp-ui/agreement-coordination/agreement-coordination-search-button-eng.png)
3. The results will display agreement coordinations along with related information and approvers.
![Search results](../images/opp-ui/agreement-coordination/agreement-coordination-search-result-eng.png)
4. By clicking the document icon in the approvers table, you can also view related agreements.
![Related agreements button](../images/opp-ui/agreement-coordination/agreement-coordination-related-agreement-eng.png)
...
- For modifying existing open supply agreement, the request must include the desired dates for the agreement:
    - `proposedValidFrom` indicates the new desired start date of the agreement (valid_from must not be later than 31.12.2035);
    - `proposedValidTo` indicates the new desired end date of the agreement (valid_to must be NULL or earlier than 01.01.2080).
- For adding new open supply agreement, the request must additionally include open supply agreement data.
- For deleting an existing open supply agreement, the request must include the ID of the open supply agreement
...
- `agreementAction` indicates whether the action is creating, updating, or deleting the agreement. Possible options are: `CREATE`, `UPDATE`, and `DELETE`.
