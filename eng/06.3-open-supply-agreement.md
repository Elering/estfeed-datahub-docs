...
To add a open supply agreement in the web interface, the user role must be "Open Supplier". Then navigate to the "Agreements" -> "New agreement" page, on which the view for adding a new agreement will open:
