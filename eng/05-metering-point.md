...
| storageCapacity       | Storage Capacity                    | storage capacity in kW                     | no                       | yes                      | Must be integer or floating (max. 2 positions after comma) number. Leave empty if no value. |
| storageEnergy         | Storage Energy                      | storage capacity  energy in kWh            | no                       | yes                      | Must be integer or floating (max. 2 positions after comma) number. Leave empty if no value. |
| productionCapacity    | Production Capacity                 | production capacity in kW                  | no                       | yes                      | Must be integer or floating (max. 2 positions after comma) number. Leave empty if no value. |
| transmissionCapacity  | Transmission Capacity               | transmission capacity in kW                | no                       | yes                      | Must be integer or floating (max. 2 positions after comma) number. Leave empty if no value. |
