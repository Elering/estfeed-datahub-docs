...
- [Tarnijavahetuse protsess](#tarnijavahetuse-protsess)
  ...
  - [Avatud tarnija vahetuse üldpõhimõtted (elektriturg)](#avatud-tarnija-vahetuse-üldpõhimõtted-(elektriturg))
  - [Avatud tarnija vahetuse üldpõhimõtted (gaasiturg)](#avatud-tarnija-vahetuse-üldpõhimõtted-(gaasiturg))
...
Elektriturul on avatud tarne reeglid ja tarnija vahetus sätestatud elektrituruseaduses ja elektrituru toimimise võrgueeskirjas toodud nõuetega. 
Gaasiturul on avatud tarne reeglid ja tarnija vahetus sätestatud maagaasiseaduses ja gaasituru toimimise võrgueeskirjas toodud nõuetega. 
Käesolevas dokumendis on kirjeldatud protsess ja reeglid, kuidas toimub avatud tarnija vahetus alates **01.01.2023**.
...
Avatud tarnija vahetuse protseduuri reeglite aluseks Andmelaos on elektriturul elektrituruseaduses ja elektrituru toimimise võrgueeskirjas sätestatud nõuded ning gaasiturul maagaasiseaduses ja gaasituru toimimise võrgueeskirjas sätestatud nõuded.

1. Avatud tarne lepingu algusaja mõõtepunktis sisestab Andmelattu avatud tarnija.
2. Avatud tarne lepingu saab lõpetada avatud tarnija ise enda avatud tarne lepingute osas või lõpetab avatud tarne lepingu Andmeladu, kui mõõtepunktis registreerib kliendi kohta uue avatud tarne lepingu uus avatud tarnija.
3. Kui avatud tarnija ütleb avatud tarne lepingu üles või lõpetab selle muul viisil, sisestab ta Andmelattu lepingu lõpetamise andmed.
4. Uus avatud tarnija edastab Andmelattu teate uue avatud tarne lepingu kohta seadusandluses toodud tähtajaks.
5. Uus avatud tarnija peab enne avatud tarne lepingu sõlmimist Andmelao kaudu kontrollima, kas turuosalisel on olemas kehtiva võrgulepinguga mõõtepunkt, mille kohta isik soovib avatud tarne lepingut sõlmida ning kas turuosalise kehtiv avatud tarne leping sisaldab ennetähtaegse lepingu lõpetamise tasunõuet. Viimase korral on avatud tarnija kohustus informeerida turuosalist lepingu nõudest veendumaks, et turuosaline on teadlik tarnijavahetusega kaasnevatest võimalikest kuludest

Elektrituru spetsiifiline:
...
Gaasituru spetsiifiline:

1. Avatud tarnija võib gaasiturul reeglina vahetuda (leping jõustub) kalendirikuu vahetusel. Erandid: avatud tarne leping lõppeb kuu keskel, kui see ühtib võrgulepingu lõppkuupäevaga. Avatud tarne leping algab kuu keskel, kui see ühtib võrgulepingu alguskuupäevaga.
...
Avatud tarnija vahetumine võib toimuda elektriturul **misiganes** kalendripäeval, gaasiturul üldjuhul kuu vahetusel järgides allolevat protsessi:
...
|                                                                                                                 | Elektriturg | Gaasiturg |
|-----------------------------------------------------------------------------------------------------------------|--------------|-----------|
| Uue võrgulepingu algusaeg                                                                              | 22.04.2017 kell 00.00| 22.04.2017 kell 07.00|
| Uue võrgulepingu sisestamise lõpptähtaeg võrguettevõtjale                                              | 21.04.2017 kell 23.59| 22.04.2017 kell 06.59|
| Uue avatud tarne lepingu sisestamise lõpptähtaeg avatud tarnijale                                      | 23.04.2017 kell 23.59| 24.04.2017 kell 06.59|
