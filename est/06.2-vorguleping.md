...
|------------------------------------------------------------------------------------------------------------------------------------|--------------|-----------|
| Lepingut saavad lisada järgmised turuosalised, kes on lepingus nimetatud mõõtepunkti omanikud, ehk mõõtepunkti lisajad             | võrguettevõtja (GO), tootja (PO), liinivaldaja (LO), laadimispunkti operaatori (CO) või suletud jaotusvõrgu valdaja (CDN)        | võrguettevõtja (GO), tootja (PO)       |
| Lepingu lõppkuupäeva tohib tagasiulatuvalt muuta ainult juhul, kui see ei mõjuta avatud tarne ega agregeerimise lepingut. Loe rohkem peatükist [Kooskõlastust nõudvad lepingumuudatused](06.8-kooskolastusega-lepingute-muudatused.md).                                                                                | KEHTIB | KEHTIB avatud tarne lepingu korral, agregeerimise lepinguid gaasiturul ei ole |
| Kui mõõtepunktis on kehtiv või tulevikus kehtima hakkavaid SUPPLY/AGGREGATION lepinguid, siis GRID lepingu muutmisel ei tohi `validTo` väärtus olla minevikus ja peab olema minimaalselt lähim ööpäeva vahetus.                                                                                  |Hetke kuupäeva ja kellaaeg on 07.01.2025 23:50 (Eesti aeg), Minimaalne lubatud `validTo` väärtus on 08.01.2025 00:00 (Eesti aeg) | Hetke kuupäeva ja kellaaeg on 07.01.2025 23:50 (Eesti aeg), Minimaalne lubatud `validTo` väärtus on 08.01.2025 07:00 (Eesti aeg)     |
...
Võrgulepingu lisamiseks veebiliideses tuleb navigeerida lehele "Lepingud" -> "Uus leping", mille peale avaneb uue lepingu lisamise vaade.
