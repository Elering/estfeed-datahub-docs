...
**Avatud tarne** tähendab turuosalisele kogu temale vajaliku maagaasi või elektrienergia müümist või turuosalisele tema bilansi tagamiseks kauplemisperioodil puudu jääva maagaasi või elektrienergia koguse müümist või temalt kauplemisperioodil ülejääva maagaasi või elektrienergia koguse ostmist.
...
5. **Elektriturul** vahetub avatud tarnija elektrituru toimise võrgueeskirjas ettenähtud ajal.
6. **Gaasiturul** vahetub avatud tarnija gaasuturu toimimise võrgueeskirjas ettenähtud ajal.
...
Avatud tarne lepinguta teenus jaguneb elektriturul kolme gruppi (gaasiturul sellist jagunemist ei ole):
...
> [!WARNING] 
> **Gaasituru spetsiifiline:** Avatud tarnija võib gaasiturul reeglina vahetuda (leping jõustub) kalendirikuu vahetusel. 
> **Erandid:** avatud tarne leping lõppeb kuu keskel, kui see ühtib võrgulepingu lõppkuupäevaga. 
> Avatud tarne leping algab kuu keskel, kui see ühtib võrgulepingu alguskuupäevaga.
...
2. Avatud tarne leping saab jõustuda alates võrgulepingu jõustumise kuupäevast. Võrgulepingu lõpetamise korral lõpeb avatud tarne leping võrgulepingu lõpupäeval südaöösel (gaasuturul võrgulepingu lõpupäevale järgneval päeval kell 7:00).
...
2. Avatud tarne lepingu katkemise korral vahetub avatud tarnija lepingu katkemise päeval kell 00.00 (gaasiturul lepingu katkemise päevale järgneval päeval kell 7:00).
3. Kui pärast avatud tarne lepingu katkemist sõlmitakse uus avatud tarne leping, vahetub avatud tarnija uue lepingu sõlmimisele järgneval päeval kell 00.00 (gaasiturul kell 7:00).
...
- Andmeladu teeb lisandunud või muutunud avatud tarne lepingu info kättesaadavaks võrguettevõtjale ja agregaatorile kasutades andmete levitamise teenust
- Avatud tarnija vahetuse puhul teeb Andmeladu eelmisele avatud tarnijale info kättesaadavaks andmete levitamise teenuse abil
