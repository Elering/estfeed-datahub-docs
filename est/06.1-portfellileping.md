...
Iga võrguettevõtja, avatud tarnija ja agregaator peab omama mõne teise avatud tarnijaga oma portfelli kohta avatud tarne lepingut, mida nimetatakse portfelli lepinguks (kui tarbijal ja tootjal on avatud
tarne lepingud mõõtepunktide lõikes, siis võrguettevõtjal, avatud tarnijal ja agregaatoril on avatud tarne lepinguid juriidilise isiku lõikes).
...
Kui agragaatoril puudub portfellileping, ei saa ta agregaatorina tegutseda ning süsteemihaldur lõpetab tema tegevuse ja agregeerimise lepingud.
...
5. Leping algab alati kuu esimesest päevast, seetõttu tuleb valida vaid kuu. Lepingu alguseni peab jääma elektriturul vähemalt 7 päeva (gaasiturul 14 päeva).
...
| Reegel                                                                                                                             | Elekteriturg | Gaasiturg |
|------------------------------------------------------------------------------------------------------------------------------------|--------------|-----------|
| Lepingu algus tohib olla ainult kuu esimene päev                                                                                 | JAH          | JAH       |
| Lepingu algus peab olema vähemalt X päeva tulevikus                                                                               | 7 päeva      | 14 päeva  |
| Lepingu lõpp tohib olla ainult kuu viimane päev                                                                                  | JAH          | JAH       |
| Lepingu lõpp peab olema vähemalt X päeva tulevikus                                                                                | 7 päeva      | 14 päeva  |
| Lepingu andmestikus ei tohi olla mõõtepunkte.                                                                                     | JAH          | JAH       |
| Lepingus ei tohi sätestada enneaegse lõpetamise tasu.                                                                              | JAH          | JAH       |
| Lepingut ei saa kustutada, kui lepingu kehtivuseni on jäänud vähem kui X päeva.                                                    | 7 päeva | 14 päeva |
| Lepingut saab lisada ainult avatud tarnija (OS) rollis turuosaline.                                                               | JAH          | JAH       |
| Lepingu teenusepakkujaks (`serviceProvider`) peab olema lepingu registreerija ja kliendiks (`customer`) võib olla suvaline turuosaline. | JAH          | JAH       |
| Lepingu lisamine iseendale ei ole lubatud (`serviceProvider` ja `customer` ei tohi olla samad) | JAH | JAH |        
