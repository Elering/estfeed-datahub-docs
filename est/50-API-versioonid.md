...
| PUT    | /api/v2/agreements/{id}                      | v2       | aktiivne | 17.09.2025       | -                | -                 |                                                                       |
| POST   | /api/v1/template/meter                       | v1       | aegunud  | 22.11.2024       | 10.11.2025       | 30.05.2026        | Veebiliides kasutab uut versiooni.                                 |
...
| POST   | /api/v1/meter/import                         | v1       | aegunud  | 22.11.2024       | 10.11.2025       | 30.05.2026        | Veebiliides kasutab uut versiooni.                                |
| POST   | /api/v1/meter/export                         | v1       | aegunud  | 22.11.2024       | 10.11.2025       | 30.05.2026        | Veebiliides kasutab uut versiooni.                               |
...
| POST   | /api/v2/metering-data/electricity                           | v2      | tulemas | 20.07.2026       | -               | -                 |                                                                   |
...
| POST   | /api/v1/meter-data/search                    | v1       | aktiivne | 22.11.2024       | 20.07.2026                | 31.01.2027                 | Seda versiooni ei saa kasutada neto mõõdetud andmete pärimiseks. 
...
| GET    | /api/v2/data-distributions/metering-data/electricity        | v2       | tulemas | 20.07.2026      | -                | -                 |                                                                       |
| GET    | /api/v2/data-distributions/network-bill         | v2       | tulemas | 01.08.2026      | -                | -                 |                                                                       |
