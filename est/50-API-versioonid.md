...
| POST   | /api/v1/meter-data                           | v1       | aktiivne | 22.11.2024       | 01.08.2026                | -                 | Alates 01.08.2026 ei saa seda kasutada võrguettevõtjad ja suletud jaotusvõrgu ettevõtjad.  
| POST   | /api/v2/metering-data/electricity                           | v2      | tulemas | 01.08.2026       | -               | -                 |                                                                   |
| POST   | /api/v1/meter-data/status                    | v1       | aktiivne | 22.11.2024       | -                | -                 |                                                                       |
| POST   | /api/v1/meter-data/search                    | v1       | aktiivne | 22.11.2024       | 01.08.2026                | -                 | Seda versiooni ei saa kasutada neto mõõdetud andmete pärimiseks. 
| GET   | /api/v2/metering-data/electricity                    | v2       | tulemas | 01.08.2026       | -                | -                 |                                                                         |
| POST   | /api/v1/meter-data/import                    | v1       | aktiivne | 22.11.2024       | 01.08.2026                | 01.08.2026                 |Veebiliides hakkab kasutama v2 versiooni alates 01.08.2026.                                                                     |
| POST   | /api/v1/meter-data/export                    | v1       | aktiivne | 22.11.2024       | 01.08.2026                | 01.08.2026                | Veebiliides hakkab kasutama v2 versiooni alates 01.08.2026.                                                                      |
| POST   | /api/v1/template/meter-data                  | v1       | aktiivne | 22.11.2024       | 01.08.2026                | 01.08.2026                | Veebiliides hakkab kasutama v2 versiooni alates 01.08.2026.                                                                      |
...
| GET    | /api/v2/data-distributions/metering-data/electricity        | v2       | tulemas | 01.08.2026      | -                | -                 |                                                                       |
