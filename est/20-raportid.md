...
- **LEHT "GO GO OUT"**:
  ...
  - võrguettevõtja EIC – võrguettevõtja EIC kood (parentGridProviderEic)
  - Võrguettevõtja – võrguettevõtja nimi (parentGridProviderName)
...
- **LEHT "OS_GO"**:
  ...
  - Võrku sisenenud netokogus lõppklienidilt, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityPortfolio ja netOutQuantityPortfolio. (netInQuantityPortfolio) (ainult elektriturg)
  - Võrgust väljunud netokogus lõppkliendile, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityPortfolio ja netOutQuantityPortfolio.  (netOutQuantityPortfolio) (ainult elektriturg)
  ...
  - Isoleeritud võrku sisenenud netokogus lõppkliendilt, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netInQuantityIsolated) (ainult elektriturg)
  - Isoleeritud võrgust väljunud netokogus lõppkliendile, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netOutQuantityIsolated) (ainult elektriturg)
...
- **Leht "BH_GO"**
  ...
  - Portfelliväline võrku sisenenud netokogus kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantity ja netOutQuantity. (netInQuantity) (ainult elektriturg)
  - Portfelliväline võrgust väljunud netokogus kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantity ja netOutQuantity. (netOutQuantity) (ainult elektriturg)
  ...
  - Portfelliväline isoleeritud võrku sisenenud netokogus, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netInQuantityIsolated) (ainult elektriturg)
  - Portfelliväline isoleeritud võrgust väljunud netokogus, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netOutQuantityIsolated) (ainult elektriturg)
  - Mõõtepunktide arv, tk (meteringPointsTotal)
- **Leht "BH_OS"**
  ...
  - Võrku sisenenud netokogus, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantity ja netOutQuantity. (netInQuantity) (ainult elektriturg)
  - Võrgust väljunud netokogus, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantity ja netOutQuantity. (netOutQuantity) (ainult elektriturg)
  ...
  - Isoleeritud võrku sisenenud netokogus, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netInQuantityIsolated) (ainult elektriturg)
  - Isoleeritud võrgust väljunud netokogus, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netOutQuantityIsolated) (ainult elektriturg).
...
- **LEHT "BH_OS_GO"**
  ...
  - BH portfellis võrku sisenenud netokogus lõppkliendilt, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantity ja netOutQuantity. (netInQuantity)
  - BH portfellis võrgust väljunud netokogus lõppkliendile, kwh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantity ja netOutQuantity. (netOutQuantity)
  ...
  - BH portfellis isoleeritud võrgust väljunud kogus lõppkliendile, kWh – võrgust väljunud kogus Pout (kõik isoleeritud MPd, kus on kehtiv võrguleping ja punkt ei ole GO-GO piiripunkt (outQuantityIsolated))
  - BH portfellis isoleeritud võrku sisenenud netokogus lõppkliendilt, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netInQuantityIsolated)
  - BH portfellis isoleeritud võrgust väljunud netokogus lõppkliendile, kWh. Kahesuunaliste võrgu isoleeritud mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste isoleeritud mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQuantityIsolated ja netOutQuantityIsolated. (netOutQuantityIsolated)
  - Mõõtepunktide arv, tk (meteringPointsTotal)
- **LEHT "BH_GO_OS_GO"**
  ...
  - BH portfellis GO võrku sisenenud netokogus võrgulepinguga üldteenuse lõppkliendilt, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQtyPortfolioLastResortSupply ja netOutQtyPortfolioLastResortSupply. (netInQtyPortfolioLastResortSupply)
  - BH portfellis GO võrgust väljunud netokogus võrgulepinguga üldteenuse lõppkliendile, kWh. Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netInQtyPortfolioLastResortSupply ja netOutQtyPortfolioLastResortSupply. (netOutQtyPortfolioLastResortSupply)
...
- **Leht "BMS_RAPORT"**
  ...
  - Bilansiperiood – bilansiperioodi algust tähistav aeg (kuupäev + kellaaeg) (DateTime)
  - Tootmine - Tootmine mõõtepunktides, mis on bilansihalduri portfellis, kuid võrguettevõtja ei ole samas portfellis. Sellest lahutatakse kogused, kus võrguettevõtja kuulub bilansihalduri portfelli, kuid avatud tarnija kuulub teise bilansihalduri portfelli. Arvesse võetakse ka isoleeritud mõõtepunktide kogused. (portfolioProduction)
  - Tarbimine - Tarbimine mõõtepunktides, mis on bilansihalduri portfellis, kuid võrguettevõtja ei ole samas portfellis. Sellest lahutatakse kogused, kus võrguettevõtja kuulub bilansihalduri portfelli, kuid avatud tarnija kuulub teise bilansihalduri portfelli. Arvesse võetakse ka isoleeritud mõõtepunktide kogused. (portfolioConsumption)
  - Neto tootmine - Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netPortfolioProduction ja netPortfolioConsumption. (netPortfolioProduction) (ainult elektriturg)
  - Neto tarbimine - Kahesuunaliste võrgu mõõtepunktide puhul, mille netokogused (netIn ja netOut) on edastatud Estfeed Datahubi, kasutatakse raportis neid netoväärtusi. Kõigi teiste mõõtepunktide puhul võetakse arvesse tavapäraseid In ja Out koguseid. Raportis agregeeritakse nii netokogused kui ka tavapärased kogused veergudesse netPortfolioProduction ja netPortfolioConsumption. (netPortfolioConsumption) (ainult elektriturg)
...
**Leht "GO_MP"**
  ...
  - Neto positsioonid - Neto positsioonide arv resolutsiooni järgi unikaalse lepingu kohta (netPositions) (ainult elektriturg)
  - In netokoguste edastuste arv (in) - loendatakse kokku (count) edastatud netokogused (sh nullkogused) (netInCount) (ainult elektriturg)
  - Out netokoguste edastuste arv (out) - loendatakse kokku (count) edastatud netokogused (sh nullkogused) (netOutCount) (ainult elektriturg)
  - Netokoguste edastuste arv (in = out = 0) - loendakse kokku (count) edastatud netokogused, kus nii in kui out on mõlemad korraga nullid (netPositionsNCount) (ainult elektriturg)
