...
- Andmeladu teeb lisandunud või muutunud avatud tarne lepingu info kättesaadavaks võrguettevõtjale ja agregaatorile kasutades teenust `change`
- Avatud tarnija vahetuse puhul teeb Andmeladu eelmisele avatud tarnijale info kättesaadavaks `change` teenuse abil
